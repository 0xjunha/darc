...
- [Query protocol](query-protocol.md)
  Includes the canonical JSON read commands (`list`, `show`, `search`, `stats`, and `resolve`), payload contracts,
  turn-scoped search, compact `--view oneline` skims, session bundles, and best-effort
