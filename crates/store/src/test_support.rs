...
impl<'a> IndexedTurnFixture<'a> {
    ...
    pub fn new(
        ...
        Self {
            ...
            provider_total_token_count: None,
...
pub fn insert_indexed_turn(connection: &Connection, fixture: IndexedTurnFixture<'_>) -> Result<()> {
    ...
    connection.execute(
        ...
        rusqlite::params![
            ...
            fixture.provider_total_token_count,
            fixture.input_uncached_token_count,
            fixture.cache_read_token_count,
            fixture.cache_write_token_count,
            fixture.output_token_count,
            fixture.reasoning_token_count,
