...
pub use query::{
    ...
    FilesQueryMode, FilesQueryRequest, HardDebuggingTurn, ProjectIndexAggregate, ProjectInsights,
    ...
    WorkspaceQueryData, list_project_index_aggregates, lookup_project_session_id,
