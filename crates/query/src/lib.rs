...
pub use query::{
    ...
    FilesQueryRequest, ProjectIndexAggregate, ProjectInsights, ProjectSummary, ProjectTimeStat,
    ResolveSessionQueryData, ResolveSessionQueryRequest, ResolvedSessionMatch, RootAvailability,
    RootInfo, SearchEvidenceField, SearchMode, SearchSnippetMatcher, SearchTurnHit,
    SearchTurnMatch, SearchTurnsQueryData, SearchTurnsRequest, SessionBundleQueryData,
    SessionBundleQueryRequest, SessionBundleView, SessionFileSummary, SessionFilesQueryData,
    ...
    query_turn_exists, query_turn_insights, query_workspace_insights, search_snippet_match_range,
};
