...
pub use query::{
    ...
    SessionKind, SessionOriginScope, SessionRuntimeStat, SessionSummary, SessionsQueryData,
    SessionsQueryRequest, SessionsView, ShellCommandSummary, ToolUsageStat, TurnDetail,
    TurnDetailInsights, TurnDetailOptions, TurnExistenceResolver, TurnInsights, TurnSummary,
    TurnsQueryData, TurnsQueryRequest, TurnsView, WorkspaceDailyTimeStat, WorkspaceInsights,
    WorkspaceQueryData, display_path_for_access, list_project_index_aggregates,
    ...
    query_workspace_insights, search_snippet_match_range,
};
